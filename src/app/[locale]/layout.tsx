...
export default async function RootLayout({
  ...
  const footerResponse = await getRequest<SectionData>('/sections/footer');
  const footerData = footerResponse.data.data as FooterData;

  const contactInfoResponse = await getRequest<SectionData>(
    '/sections/contact-info'
  );
  const contractInfoData = contactInfoResponse.data.data as ContactInfoData;
      ...
      >
        <NextIntlClientProvider messages={messages}>
          ...
          <Footer
            ...
            lang={locale}
            contactInfoData={contractInfoData}
          />
